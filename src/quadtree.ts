...
class QuadTree {
  ...
  //     .sort(
  //       (a, b) =>
  //         a.boundary.distanceFrom(searchPoint) -
  //         b.boundary.distanceFrom(searchPoint)
  //     )
  //     .forEach((child) => {
  ...
  //     found: found
  //       .sort(
  //         (a, b) => a.distanceFrom(searchPoint) - b.distanceFrom(searchPoint)
  //       )
  //       .slice(0, maxCount),
  //     furthestDistance,
  //   };
